  ...
  return (
    ...
    >
      <div
        className={
          nav
            ? "fixed left-0 bottom-0 w-[100%] h-screen bg-light dark:bg-black p-10 ease-in-out duration-500"
            : "fixed left-0 bottom-[-100%] w-[100%] h-screen bg-light/50 dark:bg-black/50 ease-out duration-500"
        }
      >
