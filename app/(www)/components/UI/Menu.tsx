...
const Navbar = () => {
  ...
  return (
    <div
      className={
        nav
          ? "fixed overflow-hidden left-0 top-0 backdrop-blur-lg w-full h-screen text-dark z-50"
          : ""
      }
    >
      <div
        className={
          nav
            ? "fixed left-0 top-0 w-[100%] h-screen bg-light dark:bg-black p-10 ease-in-out duration-1000"
        ...
        >
          <div className={nav ? "ease-in duration-500" : ""}>
            <div className=" h-screen text-base text-blue dark:text-yellow">
              <div className="h-1/3 flex items-center pl-2 justify-center">
                +
              </div>
              <div className="h-1/3 flex items-center pl-2 justify-center">
                +
