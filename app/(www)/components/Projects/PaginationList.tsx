  ...
  return (
    <div className="flex w-fill items-center justify-between p-4 mb-4 border border-dotted border-neutral">
      ...
      <Tooltip text="Next_Page" disabled={!hasNextPage}>
        <button
          className={`border border-dotted border-neutral hover:border-solid bg-light dark:bg-black hover:bg-white dark:hover:bg-blacks py-4 px-4 transition-all ease-in-out duration-1000 ${!hasNextPage ? "opacity-30 cursor-not-allowed" : ""}`}
