...
const WeatherDetails = ({ data }: { data: any }) => {
  ...
  return (
    <div className="mb-4">
      <h2 className="text-2xl text-center mb-4">Weather in {data.name}</h2>

      <div className="flex flex-col md:flex-row justify-between gap-4 max-w-2xl mx-auto md:p-4 border-x md:border border-dotted items-center border-neutral">
